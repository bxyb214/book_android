...
import com.songzi.book.exception.BookIOException;
import com.songzi.book.exception.BookOtherException;
...
public class HttpClientUtils {
	...
	public static void get(final Context context, String url, Bundle params,
		...
		try {
			...
			responseListener.onFail(new BookIOException(
			...
			responseListener.onFail(new BookOtherException(

...
import com.songzi.book.activity.NewsDetailImageActivity;
import com.songzi.book.entity.NewsDetailEntity;
import com.songzi.book.task.DetailImageDownloadTask;
import com.songzi.book.task.GetNewsDetailTask;
import com.songzi.book.task.MyAsyncTask;
import com.songzi.book.task.ResponseListener;
import com.songzi.book.util.AssetsUtils;
import com.songzi.book.util.GsonUtils;
import com.songzi.book.util.NetWorkHelper;
...
public class NewsDetailFragment extends BaseFragment implements
	...
	private String replaceImgTagFromHTML(String html) {
		...
		for (Element e : es) {
			...
			String localImgPath = BookUtils.getCacheImgFilePath(getActivity(), imgUrl);
	...
	private class LoadCacheDetailTask extends MyAsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			return BookApplication.getDataSource().getContent(key);
		}

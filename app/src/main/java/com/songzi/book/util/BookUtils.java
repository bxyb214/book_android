...
public class BookUtils {
	 ...
	 * to:
	 * /storage/emulated/0/Android/data/com.songzi.book/cache/f72a0397abad8edbd98a8d2a701464ee.jpg
	 * 
	 * @param context
	 * @param imageUrl
	 * @return
	...
	public static void setReadStatus4NewsList(ArrayList<NewsEntity> newsList) {
		...
		//已读新闻列表
		ArrayList<String> readList = BookApplication.getNewsReadDataSource().getNewsReadList();
